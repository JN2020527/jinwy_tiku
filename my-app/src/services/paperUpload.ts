...
// 获取解析结果
export async function getParseResult(taskId: string): Promise<{ data: ParseResult; success: boolean }> {
...
// 提交入库
export async function submitPaper(taskId: string, questions: QuestionItem[]): Promise<{ success: boolean }> {
