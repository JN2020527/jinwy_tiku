...
const QuestionDetail: React.FC<QuestionDetailProps> = ({
    ...
    return (
        <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            {/* 题干 */}
            <div style={{ marginBottom: 16 }}>
                <div style={{ fontWeight: 600, marginBottom: 8, color: '#333' }}>题干：</div>
                <div
                    style={{
                        padding: '12px',
                        background: '#fafafa',
            ...
            {question.options && question.options.length > 0 && (
                <div style={{ marginBottom: 16 }}>
                    <div style={{ fontWeight: 600, marginBottom: 8, color: '#333' }}>选项：</div>
                ...
                items={[
                    {
                        ...
                        label: '答案',
                        children: (
                            <div dangerouslySetInnerHTML={{ __html: question.answer || '暂无答案' }} />
                        )
                    },
                    ...(question.analysis ? [{
                        key: 'analysis',
