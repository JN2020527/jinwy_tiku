        ...
        <PageContainer>
            <Card style={{ marginBottom: 24 }}>
                <Descriptions column={1}>
                    <Descriptions.Item label="产品ID">{productId || mockProductInfo.id}</Descriptions.Item>
                    <Descriptions.Item label="产品名称">{mockProductInfo.name}</Descriptions.Item>
                    <Descriptions.Item label="展示时间">{mockProductInfo.displayTime}</Descriptions.Item>
                    <Descriptions.Item label="激活类型">{mockProductInfo.activationType}</Descriptions.Item>
                    <Descriptions.Item label="是否上市">{mockProductInfo.status}</Descriptions.Item>
                </Descriptions>
            </Card>
