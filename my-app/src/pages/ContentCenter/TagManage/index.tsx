...
const TagManage: React.FC = () => {
  ...
  const [knowledgeExpandedKeys, setKnowledgeExpandedKeys] = useState<
    React.Key[]
  >([]);
  const [knowledgeAutoExpandParent, setKnowledgeAutoExpandParent] =
  ...
  const [textbookAutoExpandParent, setTextbookAutoExpandParent] =
    useState<boolean>(true);
  ...
  const titleRender = (
    nodeData: any,
    type: 'knowledge' | 'questionType' | 'textbook',
  ) => {
