...
import { PageContainer, ProForm, ProFormSelect, ProFormText, ProFormUploadDragger } from '@ant-design/pro-components';
    ...
    const handleFinish = async (values: any) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                history.push(`/question-bank/word-upload/edit?taskId=${result.data.taskId}`);
            }
            return true;
        } catch (error) {
            hide();
