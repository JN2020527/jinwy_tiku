    ...
    return (
      ...
      >
        ...
        >
          ...
          {child.difficulty && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontWeight: 600, marginBottom: 4 }}>【难度】</div>
          ...
          {child.knowledgePoints && child.knowledgePoints.length > 0 && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontWeight: 600, marginBottom: 4 }}>【知识点】</div>
    ...
    <Card
      ...
      title={
        ...
        >
          ...
          {question.difficulty && (
            <Tag color="orange">{question.difficulty} 星</Tag>
          )}
        </div>
      }
    >
