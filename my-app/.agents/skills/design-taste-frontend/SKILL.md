...
.liquid-glass-web-approx {
  ...
  box-shadow: inset 0 1px 0 rgb(255 255 255 / 0.48), inset 0 -1px 0 rgb(255 255
          255 / 0.12), 0 18px 60px rgb(0 0 0 / 0.18);
}
...
@media (prefers-color-scheme: dark) {
  .liquid-glass-web-approx {
    ...
    box-shadow: inset 0 1px 0 rgb(255 255 255 / 0.22), 0 18px 60px rgb(0 0 0 /
            0.42);
  }
}
